...
export interface ERC4626GhoInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface ERC4626Gho extends BaseContract {
  connect(runner?: ContractRunner | null): ERC4626Gho;
  waitForDeployment(): Promise<this>;

  interface: ERC4626GhoInterface;
