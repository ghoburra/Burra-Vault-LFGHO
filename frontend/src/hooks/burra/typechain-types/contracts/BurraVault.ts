...
export interface BurraVaultInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
  ...
  encodeFunctionData(
    functionFragment: "usersToShares",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
...
export namespace PermittedEvent {
...
export interface BurraVault extends BaseContract {
  connect(runner?: ContractRunner | null): BurraVault;
  waitForDeployment(): Promise<this>;

  interface: BurraVaultInterface;
  ...
  usersToShares: TypedContractMethod<[arg0: AddressLike], [bigint], "view">;
  ...
  getEvent(
    ...
    PermittedEvent.InputTuple,
    PermittedEvent.OutputTuple,
    PermittedEvent.OutputObject
  >;
  getEvent(
    key: "Transfer"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "Permitted(address,uint256)": TypedContractEvent<
      PermittedEvent.InputTuple,
      PermittedEvent.OutputTuple,
      PermittedEvent.OutputObject
    >;
    Permitted: TypedContractEvent<
      PermittedEvent.InputTuple,
      PermittedEvent.OutputTuple,
      PermittedEvent.OutputObject
    >;
