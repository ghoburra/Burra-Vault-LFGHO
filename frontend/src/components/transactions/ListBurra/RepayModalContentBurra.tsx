...
import { RepayActions } from './ListBurraActions';
import { RepayActionsBurra } from './ListBurraActionsBurra';
...
export const RepayModalContentBurra = ({
  poolReserve,
  userReserve,
  symbol: modalSymbol,
  tokenBalance,
    ...
    <>
      ...
      />
        ...
        <Typography color="InfoText">
          <Trans>
           You can List burra for others to buy. In short, here you can sell your debt to others. you'll transfer the Burra (BU) shares of the vault and the underlying collateral.
          </Trans>
        </Typography>
      ...
      {/* <TxModalDetails gasLimit={gasLimit}>
        <DetailsNumberLineWithSub
          ...
          value={debt}
          valueUSD={userPositionData?.debtInDollars.toString()}
          symbol={
